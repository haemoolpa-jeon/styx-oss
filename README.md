...
**NAT/방화벽 뒤에서 연결 문제가 있던 사용자를 위한 중요 수정입니다.**

### 🌐 네트워크 연결 개선
- **TURN 인증 수정** - NAT/방화벽 뒤에서도 연결 가능
- **연결 상태 표시 개선** - 직접 연결 / TURN 릴레이 / 실패 명확히 표시
- **자동 폴백** - 직접 연결 실패 시 자동으로 TURN 릴레이 사용
...
### 🖥️ 데스크톱 앱 (권장)
1. **다운로드**: [Styx Desktop v1.4.0](https://github.com/haemoolpa-jeon/styx-oss/releases)
2. **설치**: `Styx_1.4.0_x64-setup.exe` 실행
3. **실행**: 설치된 Styx 앱 실행
