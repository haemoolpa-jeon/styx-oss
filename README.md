...
### 🔧 개선사항
- **Performance mode 통합** - Low-latency와 Pro 모드를 radio cards로 통합
- **Sample rate 옵션 제거** - 항상 48kHz 사용 (최적)
- **Cache busting** - 버전 쿼리 파라미터로 브라우저 캐시 문제 해결
